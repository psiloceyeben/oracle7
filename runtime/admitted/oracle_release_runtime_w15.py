#!/usr/bin/env python3
"""oracle_release_runtime_w15 - POTENTIALS fold (epoch 2): the typed space of the possible.
...
Authored 2026-08-25 07:51 UTC by oracle_fold_worker_v6, chained on oracle_release_runtime_w12."""

from __future__ import annotations

import re

from oracle_release_runtime_w12 import OracleReleaseRuntimeW12
...
class OracleReleaseRuntimeW15(OracleReleaseRuntimeW12):
        ...
        if POT_RX.search(s):
            ...
            return {"status": "answered", "path": "worker:potentials",
                     "response": f"By my own ledgers, {len(POTENTIALS)} typed "
                                 ...
                                 f"[potentials_epoch_2]",
                     "provenance": {"kind": "potentials_ledger", "epoch": 2,
